...
const CARDS = [
  {
    ...
    content:
      "Une application et une API de saisie et de suivi du temps de travail dans le transport routier léger développées par le ministère de l’Aménagement du territoire et de la Décentralisation.",
    link:
