  ...
  return (
    ...
    >
      <Stack direction="row" columnGap={1} alignItems="center">
        ...
        <div>{`${nbExports} export${nbExports > 1 ? 's' : ''} d'activité en cours de préparation... Vous pouvez quitter la page pendant la préparation ${nbExports > 1 ? 'des exports' : "de l'export"}.`}</div>
      </Stack>
      <Button
