...
import { RegulatoryAlertsSummaryProvider } from "../../utils/contextRegulatoryAlertsSummary";
...
export default function RegulatoryRespectPanel() {
  ...
  return (
    <RegulatoryAlertsSummaryProvider>
      <Stack direction="column" className={classes.container} rowGap={1}>
        <Typography variant="h3" component="h1">
          Respect des seuils réglementaires
        </Typography>
        <Typography className={classes.description}>
          Suivez le respect des seuils réglementaires au sein de votre
          entreprise. Vous pouvez effectuer un suivi global ou personnalisé en
          utilisant les filtres ci-dessous.
        </Typography>
