  ...
  return (
    <>
      <Box className={classes.title}>
        <Typography variant="h4" component="h2" fontSize="1.375rem">
          Paramètres
        </Typography>
      </Box>
      <hr />
      <List>
        <ListItem>
          <OtherTask
            otherTaskLabel={adminStore.settings.otherTaskLabel}
            allowOtherTask={adminStore.settings.allowOtherTask}
